const TRANSLATIONS = Object.freeze({
  ru: {
    ...
    editor: {
      ...
      buttonActionGroup: 'Тип действия',
      buttonActionGroupNone: 'Нет действия',
      buttonActionToggleAppVisibility: 'Открыть / скрыть приложение',
      buttonActionRunUserScript: 'Запустить скрипт',
      buttonActionLaunchApp: 'Открыть / запустить приложение',
      buttonActionSetDefaultOutputDevice: 'Назначить устройство вывода',
      buttonActionSetDefaultInputDevice: 'Назначить устройство ввода',
      buttonActionMediaPrevious: 'Предыдущий трек',
      buttonActionMediaNext: 'Следующий трек',
      buttonActionMediaPlay: 'Играть',
      buttonActionMediaPause: 'Пауза',
      buttonActionMediaPlayPause: 'Плей / пауза',
      buttonActionMediaRewind: 'Перемотка назад',
      buttonActionMediaFastForward: 'Перемотка вперед',
      buttonActionMediaRepeat: 'Повтор',
      buttonActionMediaShuffle: 'Перемешивание',
      ...
      buttonIndicatorBehaviorActionState: 'Действие',
      buttonIndicatorBehaviorPeakMeter: 'Пик',
      buttonIndicatorBehaviorTargetActivity: 'Цель',
      buttonIndicatorPeakThreshold: 'Порог пика (dB)',
      buttonKey: 'Клавиша',
      ...
      targetModeFocus: 'Focus',
      deviceFlowOutput: 'Output',
      deviceFlowInput: 'Input',
      noDevicesAvailable: 'Нет доступных устройств.',
      defaultDeviceLabel: 'default',
      targetModeFocusCurrent: 'Активное приложение',
      focusExclusionsHint: 'Выберите приложения-исключения для focus target.',
      focusExclusionsCount: 'Исключений: {count}',
      focusExclusionsNone: 'Без исключений',
    ...
    mediaController: {
      editorTitle: 'Настройка плеера',
      editorSubtitle: 'Перепривязка, скрытие и порядок кнопок плеера.',
      bind: 'Привязать',
      unbound: 'Не привязано',
      targetAppLabel: 'Целевое мультимедиа приложение',
      autoTarget: 'Автоцель',
      unavailableTarget: 'Недоступная цель',
      showButton: 'Показать',
      hideButton: 'Скрыть',
      keepOneVisible: 'Оставьте хотя бы одну кнопку плеера видимой.'
    },
    layout: {
      modeOn: 'Расклад',
      modeOff: 'Расклад',
    ...
    midi: {
      ...
      bindAnyway: 'Все равно привязать',
  ...
  en: {
    ...
    editor: {
      ...
      buttonActionSetVolume: 'Set volume',
      buttonActionSendKey: 'Send key',
      buttonActionGroup: 'Action type',
      buttonActionGroupNone: 'None',
      buttonActionToggleAppVisibility: 'Open / hide app',
      buttonActionRunUserScript: 'Run user script',
      buttonActionLaunchApp: 'Open / run app',
      buttonActionSetDefaultOutputDevice: 'Set default output device',
      buttonActionSetDefaultInputDevice: 'Set default input device',
      buttonActionMediaPrevious: 'Previous track',
      buttonActionMediaNext: 'Next track',
      buttonActionMediaPlay: 'Play',
      buttonActionMediaPause: 'Pause',
      buttonActionMediaPlayPause: 'Play / pause',
      buttonActionMediaRewind: 'Rewind',
      buttonActionMediaFastForward: 'Fast forward',
      buttonActionMediaRepeat: 'Repeat',
      buttonActionMediaShuffle: 'Shuffle',
      buttonFaderActionsGroup: 'Fader controls',
      buttonOtherActionsGroup: 'Other buttons',
      buttonLinkedFader: 'Fader',
      buttonLinkedFaderEmpty: 'Add a fader first to use this action.',
      buttonChannelRequired: 'Select a fader for this button first.',
      buttonIndicatorToggle: 'Toggle',
      buttonIndicatorMeter: 'Peak meter',
      buttonIndicatorPress: 'Light on press',
      buttonIndicatorBehaviorActionState: 'Action',
      buttonIndicatorBehaviorPeakMeter: 'Peak',
      buttonIndicatorBehaviorTargetActivity: 'Target',
      buttonIndicatorPeakThreshold: 'Peak threshold (dB)',
      buttonKey: 'Key',
      ...
      deviceFlowOutput: 'Output',
      deviceFlowInput: 'Input',
      noDevicesAvailable: 'No audio devices available.',
      defaultDeviceLabel: 'default',
      targetModeFocusCurrent: 'Focused app',
      focusExclusionsHint: 'Choose apps to exclude from focused-app targeting.',
      focusExclusionsCount: 'Excluded: {count}',
      focusExclusionsNone: 'No exclusions',
    ...
    mediaController: {
      editorTitle: 'Media controller',
      editorSubtitle: 'Rebind, hide and reorder media buttons.',
      bind: 'Bind',
      unbound: 'Not bound',
      targetAppLabel: 'Target multimedia app',
      autoTarget: 'Auto target',
      unavailableTarget: 'Unavailable target',
      showButton: 'Show',
      hideButton: 'Hide',
      keepOneVisible: 'Keep at least one media button visible.'
    },
    layout: {
      modeOn: 'Layout',
      modeOff: 'Layout',
