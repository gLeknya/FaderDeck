(function initUiActions(window) {
  function patchUiSettings(patch, meta = {}) {
    return window.patchUiSettingsState?.(patch, {
      source: 'ui-actions',
      ...(meta || {})
    }) || null;
  }
  ...
  function patchUiMenu(patch, meta = {}) {
    return window.patchUiMenuState?.(patch, {
      source: 'ui-actions',
      ...(meta || {})
    }) || null;
  }
  ...
  function setActiveMenuTab(tabName, meta = {}) {
    return patchUiMenu({ activeTab: tabName || null }, {
  ...
  function setAdvancedMode(value, meta = {}) {
    return patchUiSettings({ advancedMode: Boolean(value) }, {
  ...
  function toggleAdvancedMode(meta = {}) {
    return setAdvancedMode(!(window.getAdvancedModeEnabledState?.() ?? false), meta);
  }

  function setDeveloperMode(value, meta = {}) {
    return patchUiSettings({ developerMode: Boolean(value) }, {
  ...
  function toggleFaderInterpolation(meta = {}) {
    return setFaderInterpolationEnabled(!(window.getFaderInterpolationEnabledState?.() ?? false), meta);
  }

  function setSoftTakeoverEnabled(value, meta = {}) {
    return patchUiSettings({ softTakeoverEnabled: Boolean(value) }, {
  ...
  function toggleSoftTakeover(meta = {}) {
    return setSoftTakeoverEnabled(!(window.getSoftTakeoverEnabledState?.() ?? false), meta);
  }

  function setSoftTakeoverThreshold(value, meta = {}) {
    return patchUiSettings({ softTakeoverThreshold: value }, {
  ...
  function setProfileToolbarSwitcherEnabled(value, meta = {}) {
    return patchUiSettings({ profileToolbarSwitcherEnabled: Boolean(value) }, {
  ...
  function setVolumeHudEnabled(value, meta = {}) {
    return patchUiSettings({ volumeHudEnabled: Boolean(value) }, {
  ...
  function toggleVolumeHud(meta = {}) {
    return setVolumeHudEnabled(!(window.getVolumeHudEnabledState?.() ?? true), meta);
  }

  function setVolumeHudPosition(value, meta = {}) {
    return patchUiSettings({ volumeHudPosition: value }, {
  ...
  function setVolumeHudOrientation(value, meta = {}) {
    return patchUiSettings({ volumeHudOrientation: value }, {
  ...
  function toggleVolumeHudOrientation(meta = {}) {
    const nextOrientation = (window.getVolumeHudOrientationState?.() ?? 'horizontal') === 'vertical'
      ? 'horizontal'
      : 'vertical';
  ...
  function setVolumeHudShowIcon(value, meta = {}) {
    return patchUiSettings({ volumeHudShowIcon: Boolean(value) }, {
  ...
  function toggleVolumeHudShowIcon(meta = {}) {
    return setVolumeHudShowIcon(!(window.getVolumeHudShowIconState?.() ?? true), meta);
  }

  function setVolumeHudShowTitle(value, meta = {}) {
    return patchUiSettings({ volumeHudShowTitle: Boolean(value) }, {
  ...
  function toggleVolumeHudShowTitle(meta = {}) {
    return setVolumeHudShowTitle(!(window.getVolumeHudShowTitleState?.() ?? true), meta);
  }

  function setVolumeHudShowSubtitle(value, meta = {}) {
    return patchUiSettings({ volumeHudShowSubtitle: Boolean(value) }, {
  ...
  function toggleVolumeHudShowSubtitle(meta = {}) {
    return setVolumeHudShowSubtitle(!(window.getVolumeHudShowSubtitleState?.() ?? true), meta);
  }

  function setVolumeHudShowPercent(value, meta = {}) {
    return patchUiSettings({ volumeHudShowPercent: Boolean(value) }, {
  ...
  function toggleVolumeHudShowPercent(meta = {}) {
    return setVolumeHudShowPercent(!(window.getVolumeHudShowPercentState?.() ?? true), meta);
  }

  function setVolumeHudShowMeter(value, meta = {}) {
    return patchUiSettings({ volumeHudShowMeter: Boolean(value) }, {
  ...
  function toggleShowFractionalNumbers(meta = {}) {
    return setShowFractionalNumbers(!(window.getShowFractionalNumbersState?.() ?? false), meta);
  }

  function setShowFractionalOnlyLow(value, meta = {}) {
    return patchUiSettings({ showFractionalOnlyLow: Boolean(value) }, {
  ...
  function toggleShowFractionalOnlyLow(meta = {}) {
    return setShowFractionalOnlyLow(!(window.getShowFractionalOnlyLowState?.() ?? false), meta);
  }

  function setVolumeCurveEnabled(value, meta = {}) {
    return patchUiSettings({ volumeCurveEnabled: Boolean(value) }, {
  ...
  function toggleVolumeCurve(meta = {}) {
    return setVolumeCurveEnabled(!(window.getVolumeCurveEnabledState?.() ?? false), meta);
  }

  function setVolumeCurveType(value, meta = {}) {
    return patchUiSettings({ volumeCurveType: value }, {
  ...
  function setVolumeCurveAmount(value, meta = {}) {
    return patchUiSettings({ volumeCurveAmount: value }, {
